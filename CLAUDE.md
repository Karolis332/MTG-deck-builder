...
### 2026-09-20 — Deck Score v1.3 stages 1–3 committed (not deployed); stage 4a running
...
- **Open:** c45cac4 stage 3 — typed engine recipes (conversion / tokens / counters, commanderOnly), shared engine floor `Q_BASELINE_ENGINE = .559`, cEDH closing-package support (§9.5): anchors 15/16 (Cabbage paper 58 IN on its Food recipe; Vivi 76 → 68 OUT), validation piles 200/200, cEDH 88 training / 90 holdout, fresh stride controls 187/200 S ≤ 5 (generic floor .542 was measured with stage-2 recipes; joint p95 is now .568), Standard unchanged, 1128 tests. Stage 4a running (brief `deck-score-v13-stage4a-2026-09-20.md`): re-measure the negative floor jointly + bands on stride cohorts, Vivi diagnosis — fresh ≥ 190/190; then 4b control finisher schedule (`…-stage4-…md`), Opus refuter, deploy, freeze 1.3.0. Standard total needs the §7 interaction/advantage norms revisited — operator's five spec questions still unanswered.
