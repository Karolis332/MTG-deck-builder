...
- **Open:** C2+C4 (classifier scoping, tutor category) agent mid-gate — review diff before commit. Standard web builds now ~90s cold (arsenal cost) — progress copy update queued. Operator: buy blackgrimoire.com (+.gg defensively), approve tier re-anchor + Deck Doctor pricing (MONETIZATION_NOTES.md).
