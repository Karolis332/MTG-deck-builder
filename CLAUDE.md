...
### 2026-09-20 — Deck Score v1.3 stages 1–2 committed (not deployed); stage 3 running
...
- **Open:** stage 3 (brief `deck-score-v13-stage3-2026-09-20.md`): engine-family recipes, engine-plan floor, cEDH closing support — fresh controls 189/145 → ≥ 190/190, Cabbage back in 55–70, cEDH ≥ 85; stage 4 brief written (`…-stage4-…md`, control schedule); then Opus refuter → deploy → freeze 1.3.0. Standard total needs the §7 interaction/advantage norms revisited — operator's five spec questions first.
