...
Generated 2026-09-21T15:38:45.395Z. Raw v1 numbers — weights are NOT tuned in this unit (docs/DECK_SCORE_SPEC.md §4 is a separate calibration pass).
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---:|---:|---:|---|---|---|---:|
| meren-powerhouse | commander | 56 | 97.8 | 94.4 | 95 | 82 | 45.3 | 100 | 50 | aristocrats | 0.495 | 1.000 | 0.683 | quality_cap<=56.2 | 65-80 | OUT | 64.50 |
| cabbage-cedh-input | commander | 59 | 82.5 | 85.1 | 97.5 | 85 | 49 | 97.7 | 50 | conversion | 0.424 | 0.667 | 0.683 | quality_cap<=59.2 | 35-50 | OUT | 16.95 |
| precon-witherbloom | commander | 23 | 96.9 | 83 | 60.7 | 65 | 3.2 | 100 | 50 | lifegain | 0.485 | 0.833 | 0.683 | quality_cap<=22.6 | 40-55 | OUT | 10.36 |
| the-cabbage-merchant | commander | 54 | 92.3 | 94.6 | 70.6 | 74.6 | 42.5 | 100 | 50 | conversion | 0.455 | 0.778 | 0.683 | quality_cap<=54 | 55-70 | OUT | 12.62 |
| imotekh-the-stormlord | commander | 51 | 88.1 | 93.4 | 51.9 | 74.6 | 38.9 | 100 | 50 | recursion | 0.495 | 1.000 | 0.683 | quality_cap<=51.1 | 45-65 | IN | 14.74 |
| tazri-beacon-of-unity | commander | 56 | 90.4 | 94.4 | 96 | 65 | 45.3 | 100 | 50 | typal | 0.475 | 1.000 | 0.683 | quality_cap<=56.2 | 40-60 | IN | 15.66 |
| meren-of-clan-nel-toth | commander | 19 | 97.5 | 95.6 | 95 | 81.8 | 45.3 | 100 | 50 | recursion | 0.500 | 1.000 | 0.683 | fail:structure,size; size<=19,quality_cap<=56.2 | 0-19 | IN | 13.13 |
| ramos-dragon-engine | commander | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 50 | aggro | 0.000 | 0.000 | 0.683 | quality_cap<=20 | 0-19 | IN | 1.16 |
| cabbage-merchant-current-brawl | brawl | 19 | 95.6 | 94.6 | 80.6 | 73.5 | 60.1 | 100 | 50 | conversion | 0.450 | 0.778 | 0.733 | fail:structure,size,legality; size<=19,legality<=19,quality_cap<=68.1 | 0-19 | IN | 10.84 |
| tazri-upgraded-arena | brawl | 68 | 60.4 | 87.9 | 84 | 73.5 | 65.2 | 100 | 50 | typal | 0.525 | 1.000 | 0.733 | quality_cap<=68.3 | 45-65 | OUT | 16.09 |
| kuja-genome-sorcerer-arena | brawl | 56 | 90 | 84.7 | 92 | 91.7 | 45 | 100 | 50 | spells | 0.545 | 1.000 | 0.733 | quality_cap<=56 | 60-80 | OUT | 11.52 |
| vivi-battery-arena | brawl | 86 | 87.8 | 82 | 100 | 100 | 82.7 | 100 | 50 | spells | 0.566 | 1.000 | 0.733 | quality_cap<=86.2 | 70-85 | OUT | 10.21 |
| fire-lord-azula-competitive | competitivebrawl | 76 | 83.5 | 82 | 98 | 94.6 | 70.3 | 100 | 50 | spells | 0.470 | 1.000 | 0.733 | quality_cap<=76.2 | 75-90 | IN | 9.73 |
| cedhtop16-ballooncon6 | commander | 92 | 93.8 | 75 | 100 | 78.6 | 95 | 100 | 50 | spells | 0.500 | 0.500 | 0.683 | quality_cap<=95 | 80-95 | IN | 12.52 |
| standard-1445893-univerce | standard | 73 | 65.8 | 60.5 | 94 | 77.5 | 85 | 100 | 50 | midrange | 0.567 | 1.000 | 0.300 | quality_cap<=72.6 | 70-90 | IN | 3.81 |
| standard-1445867-aljce | standard | 68 | 75.1 | 78.6 | 81.7 | 86.3 | 60.1 | 96.6 | 50 | midrange | 0.467 | 1.000 | 0.300 | quality_cap<=68.1 | 65-90 | IN | 3.54 |
