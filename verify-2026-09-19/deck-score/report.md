...
Generated 2026-09-21T05:38:07.194Z. Raw v1 numbers — weights are NOT tuned in this unit (docs/DECK_SCORE_SPEC.md §4 is a separate calibration pass).
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---:|---:|---:|---|---|---|---:|
| meren-powerhouse | commander | 75 | 97.8 | 94.4 | 95 | 82 | 68.7 | 100 | 50 | aristocrats | 0.778 | 1.000 | 0.574 | quality_cap<=75 | 65-80 | IN | 37.61 |
| cabbage-cedh-input | commander | 41 | 82.5 | 85.1 | 97.5 | 85 | 74.3 | 25.8 | 50 | midrange | 0.607 | 1.000 | 0.574 | quality_cap<=40.6 | 35-50 | IN | 12.15 |
| precon-witherbloom | commander | 54 | 96.9 | 83 | 60.7 | 65 | 42.5 | 83.3 | 50 | lifegain | 0.797 | 0.833 | 0.574 | quality_cap<=54 | 40-55 | IN | 7.09 |
| the-cabbage-merchant | commander | 56 | 92.3 | 94.6 | 62.5 | 74.6 | 48.8 | 44.8 | 50 | conversion | 0.649 | 0.750 | 0.574 | quality_cap<=55.8 | 55-70 | IN | 9.18 |
| imotekh-the-stormlord | commander | 60 | 88.1 | 93.4 | 51.9 | 74.6 | 50.6 | 77.7 | 50 | recursion | 0.672 | 1.000 | 0.574 | quality_cap<=60.5 | 45-65 | IN | 9.31 |
| tazri-beacon-of-unity | commander | 49 | 90.4 | 94.4 | 96 | 70.1 | 59.8 | 35.8 | 50 | typal | 0.619 | 1.000 | 0.574 | quality_cap<=48.6 | 40-60 | IN | 16.05 |
| meren-of-clan-nel-toth | commander | 19 | 97.5 | 95.6 | 95 | 81.8 | 68.7 | 100 | 50 | aristocrats | 0.766 | 1.000 | 0.574 | fail:structure,size; size<=19,quality_cap<=75 | 0-19 | IN | 5.80 |
| ramos-dragon-engine | commander | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 50 | aggro | 0.000 | 0.000 | 0.574 | quality_cap<=20 | 0-19 | IN | 1.07 |
| cabbage-merchant-current-brawl | brawl | 19 | 95.6 | 94.6 | 71 | 73.5 | 85 | 0 | 50 | tokens | 0.603 | 0.396 | 0.675 | fail:structure,size,legality; size<=19,legality<=19,quality_cap<=20 | 0-19 | IN | 6.76 |
| tazri-upgraded-arena | brawl | 20 | 60.4 | 87.9 | 80.4 | 77.1 | 92.2 | 0 | 50 | typal | 0.655 | 1.000 | 0.675 | quality_cap<=20 | 45-65 | OUT | 9.23 |
| kuja-genome-sorcerer-arena | brawl | 71 | 90 | 84.7 | 92 | 91.7 | 63.7 | 100 | 50 | spells | 0.750 | 1.000 | 0.675 | quality_cap<=71 | 60-80 | IN | 6.42 |
| vivi-battery-arena | brawl | 76 | 87.8 | 82 | 100 | 100 | 69.5 | 100 | 50 | spells | 0.729 | 1.000 | 0.675 | quality_cap<=75.6 | 70-85 | IN | 6.54 |
| fire-lord-azula-competitive | competitivebrawl | 87 | 83.5 | 82 | 96 | 94.6 | 83.6 | 100 | 50 | spells | 0.705 | 1.000 | 0.675 | quality_cap<=86.8 | 75-90 | IN | 6.95 |
| cedhtop16-ballooncon6 | commander | 91 | 93.8 | 75 | 100 | 78.6 | 90.5 | 100 | 50 | spells | 0.701 | 0.505 | 0.574 | quality_cap<=92.4 | 80-95 | IN | 9.77 |
| standard-1445893-univerce | standard | 73 | 65.8 | 60.5 | 94 | 77.5 | 85 | 100 | 50 | midrange | 0.872 | 1.000 | 0.300 | quality_cap<=72.6 | 70-90 | IN | 2.82 |
| standard-1445867-aljce | standard | 68 | 75.1 | 86.4 | 89 | 86.3 | 60.1 | 84.7 | 50 | aggro | 0.639 | 1.000 | 0.300 | quality_cap<=68.1 | 65-90 | IN | 2.98 |
